...
ARCHITECTURE rtl OF watermark_ip_src_Indexing IS
  ...
  COMPONENT watermark_ip_src_Index_Defin
  ...
  COMPONENT watermark_ip_src_ROM_Templat
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT watermark_ip_src_ROM_Templat_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          Temp_N                          :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
          Out1                            :   OUT   std_logic
  ...
  COMPONENT watermark_ip_src_SimpleDualP
  ...
  FOR ALL : watermark_ip_src_Index_Defin
    USE ENTITY work.watermark_ip_src_Index_Defin(rtl);

  FOR ALL : watermark_ip_src_ROM_Templat
    USE ENTITY work.watermark_ip_src_ROM_Templat(rtl);

  FOR ALL : watermark_ip_src_ROM_Templat_block
    USE ENTITY work.watermark_ip_src_ROM_Templat_block(rtl);

  FOR ALL : watermark_ip_src_SimpleDualP
    USE ENTITY work.watermark_ip_src_SimpleDualP(rtl);
...
BEGIN
  UIndex_Definer : watermark_ip_src_Index_Defin
  ...
  UROM_Template_0 : watermark_ip_src_ROM_Templat
    PORT MAP( clk => clk,
              enb => enb,
              Temp_N => Temp_N,  -- ufix10
              Out1 => Temp0_1
  ...
  UROM_Template_1 : watermark_ip_src_ROM_Templat_block
    PORT MAP( clk => clk,
              enb => enb,
              Temp_N => Temp_N,  -- ufix10
              Out1 => Temp1_1
  ...
  USimple_Dual_Port_RAM : watermark_ip_src_SimpleDualP
