-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Watermarker\watermark_ip_src_Index_Definer.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: watermark_ip_src_Index_Definer
...
ENTITY watermark_ip_src_Index_Definer IS
...
END watermark_ip_src_Index_Definer;


ARCHITECTURE rtl OF watermark_ip_src_Index_Definer IS

  -- Component Declarations
  COMPONENT watermark_ip_src_Bit_Divider_Outer
  ...
  COMPONENT watermark_ip_src_Bit_Divider_Inner
    PORT( in_rsvd                         :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
          LSBs                            :   OUT   std_logic_vector(4 DOWNTO 0);  -- ufix5
          MSBs                            :   OUT   std_logic_vector(2 DOWNTO 0)  -- ufix3
          );
  ...
  FOR ALL : watermark_ip_src_Bit_Divider_Outer
    USE ENTITY work.watermark_ip_src_Bit_Divider_Outer(rtl);

  FOR ALL : watermark_ip_src_Bit_Divider_Inner
    USE ENTITY work.watermark_ip_src_Bit_Divider_Inner(rtl);
...
BEGIN
  u_Bit_Divider_Outer : watermark_ip_src_Bit_Divider_Outer
    PORT MAP( in_rsvd => outer,  -- uint8
              LSBs => Bit_Divider_Outer_out1,  -- ufix5
              MSBs => Bit_Divider_Outer_out2  -- ufix3
              );

  u_Bit_Divider_Inner : watermark_ip_src_Bit_Divider_Inner
