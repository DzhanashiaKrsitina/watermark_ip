-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Watermarker\watermark_ip_src_waterma.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: watermark_ip_src_waterma
...
ENTITY watermark_ip_src_waterma IS
...
END watermark_ip_src_waterma;


ARCHITECTURE rtl OF watermark_ip_src_waterma IS
...
BEGIN
  UIndexing : watermark_ip_src_Indexing
    PORT MAP( clk => clk,
              rstx => rstx,
              enb => clk_enable,
              message => mes_in,
