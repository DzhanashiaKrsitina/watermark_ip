-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Watermarker\watermark_ip_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: watermark_ip_axi_lite_module
-- Source Path: watermark_ip/watermark_ip_axi_lite/watermark_ip_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY watermark_ip_axi_lite_module IS
...
END watermark_ip_axi_lite_module;


ARCHITECTURE rtl OF watermark_ip_axi_lite_module IS
...
BEGIN
  ...
  rstx <=  NOT AXI4_Lite_ARESETN;

  axi_lite_process : PROCESS (clk, rstx)
  BEGIN
    IF rstx = '1' THEN
  ...
  BEGIN
    ...
    CASE axi_lite_rstate IS
      WHEN "00000000" =>
        ...
        rvalid_int <= '0';
        IF ((arvalid AND hdlcoder_to_stdlogic(axi_lite_wstate = to_unsigned(16#00000000#, 8))) AND ( NOT 
          awvalid)) = '1' THEN 
  ...
  reg_rdata_process : PROCESS (clk, rstx)
  BEGIN
    IF rstx = '1' THEN
  ...
  reg_wdata_process : PROCESS (clk, rstx)
  BEGIN
    IF rstx = '1' THEN
  ...
  reg_waddr_process : PROCESS (clk, rstx)
  BEGIN
    IF rstx = '1' THEN
  ...
  wstrb_reduce <= (AXI4_Lite_WSTRB_unsigned(3) AND AXI4_Lite_WSTRB_unsigned(2) AND 
    AXI4_Lite_WSTRB_unsigned(1) AND AXI4_Lite_WSTRB_unsigned(0));

  w_transfer_and_wstrb <= w_transfer AND wstrb_reduce;

  reg_wr_enb_process : PROCESS (clk, rstx)
  BEGIN
    IF rstx = '1' THEN
      wr_enb_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  reg_rsvd_process : PROCESS (clk, rstx)
  BEGIN
    IF rstx = '1' THEN
      soft_reset <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  reset_internal <= rstx OR soft_reset;
