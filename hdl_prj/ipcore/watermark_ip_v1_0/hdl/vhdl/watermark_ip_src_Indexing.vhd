-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Watermarker\watermark_ip_src_Indexing.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: watermark_ip_src_Indexing
...
ENTITY watermark_ip_src_Indexing IS
...
END watermark_ip_src_Indexing;


ARCHITECTURE rtl OF watermark_ip_src_Indexing IS

  -- Component Declarations
  COMPONENT watermark_ip_src_Index_Definer
  ...
  COMPONENT watermark_ip_src_ROM_Template_0
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT watermark_ip_src_ROM_Template_1
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          Temp_N                          :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
          Out1                            :   OUT   std_logic
  ...
  COMPONENT watermark_ip_src_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : watermark_ip_src_Index_Definer
    USE ENTITY work.watermark_ip_src_Index_Definer(rtl);

  FOR ALL : watermark_ip_src_ROM_Template_0
    USE ENTITY work.watermark_ip_src_ROM_Template_0(rtl);

  FOR ALL : watermark_ip_src_ROM_Template_1
    USE ENTITY work.watermark_ip_src_ROM_Template_1(rtl);

  FOR ALL : watermark_ip_src_SimpleDualPortRAM_singlebit
    USE ENTITY work.watermark_ip_src_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  u_Index_Definer : watermark_ip_src_Index_Definer
  ...
  u_ROM_Template_0 : watermark_ip_src_ROM_Template_0
    PORT MAP( clk => clk,
              enb => enb,
              Temp_N => Temp_N,  -- ufix10
              Out1 => Temp0_1
  ...
  u_ROM_Template_1 : watermark_ip_src_ROM_Template_1
    PORT MAP( clk => clk,
              enb => enb,
              Temp_N => Temp_N,  -- ufix10
              Out1 => Temp1_1
  ...
  u_Simple_Dual_Port_RAM : watermark_ip_src_SimpleDualPortRAM_singlebit
