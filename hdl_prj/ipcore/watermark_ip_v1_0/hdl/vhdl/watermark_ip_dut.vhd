...
ARCHITECTURE rtl OF watermark_ip_dut IS
  ...
  COMPONENT watermark_ip_src_watermarking
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : watermark_ip_src_watermarking
    USE ENTITY work.watermark_ip_src_watermarking(rtl);
...
BEGIN
  u_watermark_ip_src_watermarking : watermark_ip_src_watermarking
    PORT MAP( clk => clk,
              clk_enable => enb,
              rstx => rstx,
