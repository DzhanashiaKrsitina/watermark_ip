-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Watermarker\watermark_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: watermark_ip_axi_lite
-- Source Path: watermark_ip/watermark_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY watermark_ip_axi_lite IS
...
END watermark_ip_axi_lite;


ARCHITECTURE rtl OF watermark_ip_axi_lite IS

  -- Component Declarations
  COMPONENT watermark_ip_addr_decoder
  ...
  COMPONENT watermark_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : watermark_ip_addr_decoder
    USE ENTITY work.watermark_ip_addr_decoder(rtl);

  FOR ALL : watermark_ip_axi_lite_module
    USE ENTITY work.watermark_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_pixel_in_tmp               : std_logic_vector(7 DOWNTO 0);  -- ufix8
...
BEGIN
  u_watermark_ip_addr_decoder_inst : watermark_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_pixel_out => read_pixel_out,  -- ufix8
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_pixel_in => write_pixel_in_tmp,  -- ufix8
              write_mes_in => write_mes_in  -- ufix1
              );

  u_watermark_ip_axi_lite_module_inst : watermark_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_pixel_in <= write_pixel_in_tmp;
